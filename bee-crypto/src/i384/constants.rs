...
/// A bigint containing the result when transforming a `t243` 0 to binary, where the `t243`
/// contains only 0s in terms of balanced trits (or only 1s, in terms of unbalanced, unsigned trits
/// that encode {0, 1, 2}).
///
/// So `LE_U32_TERNARY_0` is the result of the sum 1 * 3^0 + 1 * 3^1 + ... + 1 * 3^241 + 1*3^242.
pub const LE_U32_TERNARY_0: I384<LittleEndian, U32Repr> = I384::<LittleEndian, U32Repr>::from_array([
    0xa5ce8964,
    0x9f007669,
    0x1484504f,
    0x3ade00d9,
